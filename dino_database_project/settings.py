"""
Django settings for dino_database_project project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dino_database_project.context_processors.auth_context_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'dino_database_project.wsgi.application'
